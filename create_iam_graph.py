...
def create_graph(iam_iterator, projects):
    ...
    for counter, project in enumerate(projects):
        ...
        project_properties = {k: v for k, v in list(project.items()) if
    ...
    for counter, project in enumerate(projects):
        ...
        for sa in iam_iterator.list_service_accounts(project_id):
            ...
            if sa_id not in nodes:
                continue
            sa_properties = {k: v for k, v in list(sa.items()) if
...
if __name__ == '__main__':
    ...
    template_renderer.render(nodes, edges, './templates/iam_graph_full.html')
